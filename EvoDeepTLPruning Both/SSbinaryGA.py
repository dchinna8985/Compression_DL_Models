...
class BGA():
    ...
    def evaluation(self, pop):
        ...
        for i in range(len(pop)):
            ...
            if code_ind in self.memory:
                ...
                f = open(self.method.get_problem_name() +
                         self.cadena+".txt", "a+")
    ...
    def initialization(self):
        ...
        poblacion = [list(map(int, poblacion[i]))
                     for i in range(self.pop_shape[0])]
    ...
    def selection_nam(self):
        ...
        dist = [hamming(self.pop[parent1, :], self.pop[c, :])
                for c in candidates]
...
#         fitness_ = fitness
    ...
    def run(self):
        ...
        while (self.evaluaciones < self.max_evals):
            ...
            sorted_pop, sorted_accs, indices = get_best_elements(
                len(self.pop), self.pop, self.fitness)
            ...
            print("Num unos primera mitad: " +
                  str(list(global_best_ind)[:512].count(1)))
            print("Num unos segunda mitad: " +
                  str(list(global_best_ind)[512:].count(1)))
        ...
        print('\n Solution: {} \n Fitness: {} \n Evaluation times: {}'.format(
            global_best_ind, global_best_fitness, self.evaluaciones))
